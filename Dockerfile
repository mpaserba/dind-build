...
RUN apk add curl jq python3 py-pip docker-compose vault nodejs npm git tzdata
...
RUN curl -LO https://dl.k8s.io/release/v1.21.0/bin/linux/amd64/kubectl --output /usr/local/bin/kubectl && \
